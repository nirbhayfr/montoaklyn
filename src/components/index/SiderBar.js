  ...
  return (
    ...
    >
      ...
      <div className="ul-sidebar-about d-none d-lg-block">
        ...
        <p className="mb-0">
          Montoaklyn is a premium e-commerce platform celebrating the rich
          heritage of Indian tradition. Our curated collection blends timeless
          craftsmanship with modern design, offering everything from traditional
          attire and handcrafted jewelry to artisanal home décor and
          accessories. Each product tells a story of India’s vibrant culture,
          made by skilled artisans from across the country. At Montoaklyn, we
          believe in preserving traditions while embracing contemporary elegance
